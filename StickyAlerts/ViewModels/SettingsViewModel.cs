...
namespace StickyAlerts.ViewModels
{
    public partial class SettingsViewModel : ObservableObject
    {
        ...
        public Theme Theme
        {
            get => _userSettingsService.Current.Theme switch { "System" => Theme.System, "Light" => Theme.Light, "Dark" => Theme.Dark, _ => Theme.System, };
            set => SetUserSettingsProperty(_userSettingsService.Current.Theme, value switch { Theme.System => "System", Theme.Light => "Light", Theme.Dark => "Dark", _ => "System", }, true);
        }
